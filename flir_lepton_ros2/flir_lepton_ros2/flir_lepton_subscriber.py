...
class FlirLeptonSubscriber(Node):


    def __init__(self):
        super().__init__('flir_lepton_subscriber')
        self.subscriber = self.create_subscription(ThermalRaw, 'lepton/thermal_raw', self.callback, 10)
